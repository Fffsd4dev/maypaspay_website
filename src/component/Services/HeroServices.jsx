        ...
        <section ref={heroRef} className="section-spacing-lg bg-secondary relative z-1" data-hero-banner>
            ...
            <div className="container">
                <div className="text-center">
                    <h1 className="text-4xl sm:text-[40px] md:text-5xl lg:text-[52px] xl:text-[64px] leading-none! font-bold text-white" data-title>Products Services</h1>
                    <div className="flex items-center justify-center gap-2 mt-3.75" data-excerpt>
                        ...
                        <p className="text-base leading-normal font-normal text-white">Products Services</p>
                    </div>
                </div>
            </div>
        </section>
