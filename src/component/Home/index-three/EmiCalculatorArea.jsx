...
import EmiCalculator from "../index/EmiCalculator";

gsap.registerPlugin(ScrollTrigger);

export default function EmiCalculatorArea() {
  ...
  return (
    <>
        <section className="section-spacing-lg emi-calculator-section">
            <div className="container">
                <div ref={sectionRef} className="flex items-start justify-between gap-4 md:gap-10 mb-12 sm:mb-14 md:mb-16 lg:mb-20 flex-col md:flex-row max-w-125 md:max-w-full" data-section-title>
                    ...
                    <p className="md:max-w-115 w-full text-base sm:text-lg text-paragraph_black" data-content>Transparency in lending is the cornerstone of
                        trust. Use our interactive calculator to estimate your monthly repayments, visualize interest breakdowns.</p>
                </div>
