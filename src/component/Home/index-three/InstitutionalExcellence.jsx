...
import StatsCounter from "../index-two/StatsCounter";
        ...
        <section className="section-spacing-lg-md">
            <div className="container">
                <div ref={sectionRef} className="flex items-start justify-between gap-4 md:gap-10 mb-12 sm:mb-14 md:mb-16 lg:mb-20 flex-col md:flex-row max-w-125 md:max-w-full" data-section-title>
                    ...
                    <p className="md:max-w-115 w-full text-base sm:text-lg text-paragraph_black" data-content>At SecureVest, we define success through
                        the stability and growth of our clients. Our core metrics reflect a commitment to liquidity.</p>
                </div>
