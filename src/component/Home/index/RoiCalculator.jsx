...
export default function RoiCalculator() {
    ...
    return (
        <>
            <section>
                <div className="container-lg relative z-1" data-grid-reveal data-cols="15" data-rows="6" data-cols-sm="5" data-rows-sm="18" data-cols-lg="8" data-rows-lg="16" data-animation="wave" data-bg-color="white" data-trigger="top 70%" data-stagger="0.004" data-duration="0.5">
