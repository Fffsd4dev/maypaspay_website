...
export default function Benefits() {
  ...
  return (
    <>
        <section ref={sectionRef} className="section-spacing-md-lg overflow-hidden">
                ...
                <div ref={titleWrapperRef} className="flex items-start justify-between gap-4 md:gap-10 mb-12 sm:mb-14 md:mb-16 lg:mb-20 flex-col md:flex-row max-w-125 md:max-w-full" data-section-title>
                    <div className="md:max-w-170 w-full">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-base lg:text-lg font-semibold leading-[1.1]! text-secondary uppercase block">EXCLUSIVE BENEFITS</span>
                        </div>
                        <h2 className="text-3xl md:text-4xl lg:text-[40px] xl:text-5xl font-bold leading-tight text-title_black mt-4" data-content>Elite class Rewards for Your Global Lifestyle</h2>
                    </div>
                    <p className="md:max-w-115 w-full text-base sm:text-lg text-paragraph_black" data-content>Transparency in lending is the cornerstone of trust. Use our interactive tools to estimate your monthly rewards and visualize your financial growth.</p>
                </div>	
            </div>
            <div ref={cardsWrapperRef} className="" data-sttr-wrapper>
                <div ref={sliderWrapperRef} className="relative drag-cursor-wrapper cursor-none">
                    <button ref={cursorRef} className="absolute top-1/2 left-1/2 transform -translate-1/2 w-12 sm:w-20 h-12 sm:h-20 rounded-full bg-secondary text-white font-semibold text-sm sm:text-base leading-none flex items-center justify-center text-center z-99999 pointer-events-none" id="drag-cursor" type="button" aria-label="Drag cursor">
                        <span className="play-icon">Drag</span>
                    </button>
                    <div className="benefit-slider max-w-271.5 mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 relative cursor-none" data-sttr-card>
                        ...
                        >
                            ...
                            <SwiperSlide>
                                <div className="flex justify-between bg-background border border-border rounded-2xl md:rounded-3xl overflow-hidden flex-col sm:flex-row">
                                    <div className="sm:max-w-135 w-full px-5 py-7 pb-5 sm:p-8 md:p-10 lg:p-12">
                                        <p className="text-base sm:text-lg font-semibold leading-[1.1]! text-secondary capitalize">WEALTH MANAGEMENTS</p>
                                        <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-title_black mt-4">Grow Your Portfolio with Expert Precision</h3>
                                        <p className="mt-4 text-base text-paragraph_black">Our automated strategies help you maximize returns while managing risk in a volatile global market.</p>
                            ...
                            <SwiperSlide>
                                <div className="flex justify-between bg-background border border-border rounded-2xl md:rounded-3xl overflow-hidden flex-col sm:flex-row">
                                    <div className="sm:max-w-135 w-full px-5 py-7 pb-5 sm:p-8 md:p-10 lg:p-12">
                                        <p className="text-base sm:text-lg font-semibold leading-[1.1]! text-secondary capitalize">EXCLUSIVE OFFERS</p>
                                        <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-title_black mt-4">Get 20% Cashback on all International Travel</h3>
                                        <p className="mt-4 text-base text-paragraph_black">Enjoy seamless spending abroad while earning rewards on every transaction, from flights dining.</p>
                                        <ul className="mt-6 sm:mt-7 md:mt-8 lg:mt-9 flex flex-col gap-3 text-paragraph_black text-base leading-tight">
                                            <li className="flex items-center gap-2">
                                                <svg className="w-5.25 h-5.25">
                                                    <use href="#roundedCheck"></use>
                            ...
                            <SwiperSlide>
                                <div className="flex justify-between bg-background border border-border rounded-2xl md:rounded-3xl overflow-hidden flex-col sm:flex-row">
                                    <div className="sm:max-w-135 w-full px-5 py-7 pb-5 sm:p-8 md:p-10 lg:p-12">
                                        <p className="text-base sm:text-lg font-semibold leading-[1.1]! text-secondary capitalize">BUSINESS SOLUTION</p>
                                        <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-title_black mt-4">Scalable Capital for Your Next Big Move</h3>
                                        <p className="mt-4 text-base text-paragraph_black">Our platform integrates seamlessly with your existing workflow to keep your capital moving.</p>
                                        <ul className="mt-6 sm:mt-7 md:mt-8 lg:mt-9 flex flex-col gap-3 text-paragraph_black text-base leading-tight">
                                            <li className="flex items-center gap-2">
                                                <svg className="w-5.25 h-5.25">
                                                    <use href="#roundedCheck"></use>
                            ...
                            <SwiperSlide>
                                <div className="flex justify-between bg-background border border-border rounded-2xl md:rounded-3xl overflow-hidden flex-col sm:flex-row">
                                    <div className="sm:max-w-135 w-full px-5 py-7 pb-5 sm:p-8 md:p-10 lg:p-12">
                                        <p className="text-base sm:text-lg font-semibold leading-[1.1]! text-secondary capitalize">EXCLUSIVE OFFER</p>
                                        <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-title_black mt-4">Get 20% Cashback on all International Travel</h3>
                                        <p className="mt-4 text-base text-paragraph_black">Enjoy seamless spending abroad while earning rewards on every transaction, from flights dining.</p>
                                        <ul className="mt-6 sm:mt-7 md:mt-8 lg:mt-9 flex flex-col gap-3 text-paragraph_black text-base leading-tight">
                                            <li className="flex items-center gap-2">
                            ...
                            <SwiperSlide>
                                <div className="flex justify-between bg-background border border-border rounded-2xl md:rounded-3xl overflow-hidden flex-col sm:flex-row">
                                    <div className="sm:max-w-135 w-full px-5 py-7 pb-5 sm:p-8 md:p-10 lg:p-12">
                                        <p className="text-base sm:text-lg font-semibold leading-[1.1]! text-secondary capitalize">BUSINESS SOLUTIONS</p>
                                        <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-title_black mt-4">Scalable Capital for Your Next Big Move</h3>
                                        <p className="mt-4 text-base text-paragraph_black">Our platform integrates seamlessly with your existing workflow to keep your capital moving.</p>
                                        <ul className="mt-6 sm:mt-7 md:mt-8 lg:mt-9 flex flex-col gap-3 text-paragraph_black text-base leading-tight">
                                            <li className="flex items-center gap-2">
                ...
                <div className="mt-9 w-36 mx-auto bg-white rounded-[100px] benifet-slide-navigation flex! items-center justify-between" data-sttr-card>
